...
export default function JoinServerPage() {
  ...
  // Subscribe to realtime profile changes after user clicks join
  useEffect(() => {
  ...
  return (
    <div>
      <h2 className="text-2xl font-bold text-white mb-1">Join our Discord server</h2>
      <p className="text-sm text-zinc-400 mb-6">
        Join the Hesoyam Discord server so we can track your gaming activity via
        Rich Presence. This works with PC games and even console games if your
        PlayStation or Xbox is connected to Discord.
      </p>

      <div className="space-y-4">
        {joined ? (
          <div className="w-full flex items-center justify-center gap-2 bg-green-600 px-4 py-2.5 text-sm font-semibold text-white">
          ...
          <button
            disabled
            className="w-full flex items-center justify-center gap-3 bg-[#5865F2]/70 px-4 py-2.5 text-sm font-semibold text-white/80 cursor-wait"
          >
            <svg
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-3 bg-[#5865F2] px-4 py-2.5 text-sm font-semibold text-white transition hover:bg-[#4752C4]"
          >
        ...
        <button
          onClick={handleSkip}
          className="w-full border border-zinc-700 bg-zinc-800 px-4 py-2.5 text-sm font-medium text-zinc-400 transition hover:text-zinc-300 hover:border-zinc-600"
        >
          Skip for now
        </button>
      </div>
