  ...
  return (
    <div>
      ...
      <div className="space-y-4">
        ...
        <button
          onClick={handleSkip}
          className="w-full rounded-lg border border-zinc-700 bg-zinc-800 px-4 py-2.5 text-sm font-medium text-zinc-400 transition hover:text-zinc-300 hover:border-zinc-600"
        >
          Skip for now
        </button>
      </div>
