...
export default function SignupPage() {
  ...
  return (
    <motion.div initial="hidden" animate="visible">
      ...
      <motion.p custom={2} variants={item} className="mt-4 text-center text-xs text-zinc-600">
        By signing up you agree to our terms of service
      </motion.p>

      <motion.p custom={3} variants={item} className="mt-5 text-center text-sm text-zinc-600">
